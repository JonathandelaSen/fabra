...
interface ConversationListProps {
  conversations: CVChatConversation[];
...
export function ConversationList({
  ...
  const startEditing = (conv: CVChatConversation) => {
  ...
  return (
    <div className="flex max-h-48 w-full shrink-0 flex-col border-b border-line md:max-h-none md:w-64 md:border-b-0 md:border-r">
