...
const EXTERNAL_AI_PROVIDERS = [
  {
    ...
    icon: "chatgpt",
    buttonClass:
      "border-zinc-800 bg-zinc-950 text-zinc-200 hover:bg-zinc-900 hover:text-white hover:border-zinc-700",
    iconContainerClass: "text-[#10a37f]",
  },
  {
    id: "gemini",
    name: "Gemini",
  ...
  },
  {
    ...
    buttonClass:
      "border-zinc-800 bg-zinc-950 text-zinc-200 hover:bg-zinc-900 hover:text-white hover:border-zinc-700",
    iconContainerClass: "text-[#D97757]",
  },
] as const;
