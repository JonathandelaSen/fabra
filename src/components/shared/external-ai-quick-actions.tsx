...
const EXTERNAL_AI_PROVIDERS = [
  {
    ...
    iconContainerClass: "bg-[#10a37f] text-white",
  },
  {
    id: "gemini",
    name: "Gemini",
    ...
    icon: "gemini",
    buttonClass:
      "border-transparent bg-gradient-to-r from-[#4285F4] via-[#9B72CB] to-[#D96570] text-white hover:brightness-110",
    iconContainerClass: "bg-white text-zinc-900",
  },
  {
    id: "claude",
    name: "Claude",
    ...
    icon: "claude",
    buttonClass:
      "border-[#D97757]/60 bg-[#D97757] text-white hover:bg-[#c86a4d]",
    iconContainerClass: "bg-[#FBF0E9] text-[#D97757]",
  },
] as const;
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-3">
        {EXTERNAL_AI_PROVIDERS.map((provider) => (
          <button
            ...
            className={`inline-flex min-h-10 items-center justify-center gap-2 rounded-lg border px-3 py-2 text-xs font-semibold shadow-sm transition hover:shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/80 disabled:cursor-not-allowed disabled:opacity-50 ${provider.buttonClass}`}
          >
