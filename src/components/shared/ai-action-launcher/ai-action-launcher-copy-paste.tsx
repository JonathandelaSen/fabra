...
export default function AIActionLauncherCopyPaste({
  ...
  return (
    <div className="p-4 rounded-xl border border-line bg-panel-subtle hover:border-violet-500/30 hover:bg-panel-hover transition-all duration-300 flex flex-col gap-3">
