  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
        <button type="button" onClick={onCopyPrompt} disabled={!prompt || isPreparing} className="inline-flex items-center justify-center gap-2 rounded-lg bg-action px-4 py-2 text-sm font-semibold text-text-on-dark hover:bg-action disabled:opacity-50">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-end">
        <button type="button" onClick={onValidateResponse} disabled={isPreviewing || !rawResponse.trim()} className="inline-flex items-center gap-2 rounded-lg bg-action px-4 py-2 text-sm font-semibold text-text-on-dark hover:bg-action disabled:opacity-50">
