    ...
    >
      ...
      <div className="flex flex-col gap-3 pt-2">
        <button
          ...
          className="flex h-10 w-full items-center justify-center gap-2 rounded-xl bg-field-code px-4 py-2 text-xs font-semibold text-text-on-dark transition-all hover:bg-panel-control hover:shadow active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary/95"
        >
