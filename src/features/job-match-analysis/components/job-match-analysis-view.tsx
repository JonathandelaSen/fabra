...
import { JOB_MATCH_DETAIL_TABS, JOB_MATCH_VIEW_MODES, JOB_MATCH_ROUTE_VIEWS } from "../constants";
...
export default function JobMatchAnalysisView({
  ...
  return (
    <FeatureScreenShell
      ...
      mobileBackActive={(view === JOB_MATCH_ROUTE_VIEWS.list && Boolean(analysisId)) || mode === "new"}
      onMobileBack={clearSelection}
      bodyContentClassName={view === JOB_MATCH_ROUTE_VIEWS.kanban && !analysisId ? "max-w-none" : undefined}
      actions={
