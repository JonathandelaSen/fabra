...
export type RenderCVTemplatePdfInput = Parameters<
  CVTemplatePdfRenderer["render"]
>[0];

export class RenderCVTemplatePdfUseCase {
  constructor(
    private readonly deps: { templateRenderer: CVTemplatePdfRenderer },
  ) {}

  async execute(
    input: RenderCVTemplatePdfInput,
  ): Promise<RenderedCVTemplatePdf> {
